...
class Bart:
    ...
    def getData(self):
        return 'Bart', self.language, self.skf1_macro, self.mcc, self.acc, self.tn, self.fp, self.fn, self.tp
    ...
    def getCanton(self):
        ...
        for i in range(len(self.cantons)):
            ...
            cantonList.append(('Bart', self.language, self.cantons[i], self.cantonScores[i], self.cantonAmounts[i], accuracy))
        print(cantonList)
        return cantonList
    ...
    def getLegals(self):
        ...
        for i in range(len(self.legalAreas)):
            ...
            legalsList.append(('Bart', self.language, self.legalAreas[i], self.legalScores[i], self.legals[i], accuracy))
        print(legalsList)
        return  legalsList
